var app = angular.module('ProductivityTimer', []);
app.controller('MainCtrl', function($scope, $interval) {
  $scope.breakLength = 17;
  $scope.sessionLength = 52;
  $scope.timeLeft = $scope.sessionLength;
  $scope.fillHeight = '0%';
  $scope.sessionName = 'Click Me';
  $scope.currentTotal;
